...
public class KafkaConsumerSparkStream {
	...
	public static void main(String[] args) throws StreamingQueryException {
	    ...
	    .option("path", "hdfs://localhost:8020/user/cloudera/twitterImport1")
	    .option("checkpointLocation", "hdfs://localhost:8020/user/cloudera/twitterCheckpoint1") //args[1].toString()
	    .start()
	    .awaitTermination();
